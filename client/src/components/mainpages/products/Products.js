    ...
    return (
        ...
        <Filters />
        {
            ...
            <div className="delete-all"style={{textAlign:"right", margin:'20px'}} >
                <span style={{textTransform:'uppercase', color:'blue', letterSpacing:'1.3px'}}>Selectionner tous</span>
                ...
                <button onClick={deleteAll} style={{border:'1px solid crimson', padding:'10px 25px', color:'crimson', textTransform:'uppercase'}}> Supprimer Tous</button>
            </div>
        }
